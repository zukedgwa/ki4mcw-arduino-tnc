...
#include <avr/io.h> // Rob: bit bangin
/**
...
// Support for output as KISS frames

enum AX25OutputFormat
{
	AX25_OUTPUT_PARSED = 0 ,
        AX25_OUTPUT_KISS
} ;
...
enum AX25KISSSect
{
        AX25_KISS_SECT_EMPTY = 0,
        AX25_KISS_SECT_HEAD,
        AX25_KISS_SECT_HEADEND,
        AX25_KISS_SECT_GOTCNTRL,
        AX25_KISS_SECT_GOTPID,
        AX25_KISS_SECT_BODY
}
*/
...
//        enum AX25KISSSect  sect ;          // section
